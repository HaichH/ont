	...
	<section class="sec-product-detail bg0 p-t-65 p-b-60">
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
                                                            <div class="item-slick3" data-thumb="<?php echo $product['productImagePath']; ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="<?php echo $product['productImagePath']; ?>" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?php echo $product['productImagePath']; ?>">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<span class="mtext-106 cl2">
							<?php echo "R".$product['productPrice']; ?>
						</span>
						...
						<div class="p-t-33">
							<div class="flex-w flex-r-m p-b-10">
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
                                                                            <select  class="js-select2" name="sizes">
											<option></option>
                                                                                        <?php foreach ($sizes as $size): ?>
                                                                                        <option value="<?php echo $size['sizeCode']; ?>"><?php echo $size['sizeDesc']; ?></option>
											<?php endforeach; ?>
										</select>
							...
							<div class="flex-w flex-r-m p-b-10">
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
										<select class="js-select2" name="colors">
											<option></option>
                                                                                        <?php foreach ($prod_colors as $colrs): ?>
                                                                                        <option value="<?php echo $colrs['colorID']; ?>"><?php echo $colrs['colorName']; ?></option>
											<?php endforeach; ?>
										</select>
										<div class="dropDownSelect2"></div>
									</div>
									...
									<div class="wrap-num-product flex-w m-r-20 m-tb-10">
										<div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m">
											<i class="fs-16 zmdi zmdi-minus"></i>
                                                                            ...
                                                                            <input class="mtext-104 cl3 txt-center num-product" type="number" name="buy_qty" value="1" min="1">
										...
										<div class="btn-num-product-up cl8 hov-btn3 trans-04 flex-c-m">
											<i class="fs-16 zmdi zmdi-plus"></i>
                                                                    ...
                                                                    <input type="submit" value="Add to cart" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									...
									<ul class="p-lr-28 p-lr-15-sm">
										<li class="flex-w flex-t p-b-7">
											...
											<span class="stext-102 cl6 size-206">
												<?php echo $product['productWeight']; ?>
											</span>
										</li>
										...
										<li class="flex-w flex-t p-b-7">
											...
											<span class="stext-102 cl6 size-206">
												<?php echo $product['productDimmension']; ?>
											</span>
										</li>
										...
										<li class="flex-w flex-t p-b-7">
											...
											<span class="stext-102 cl6 size-206">
												<?php echo $product['productMaterials']; ?>
											</span>
										</li>
		...
		<div class="bg6 flex-c-m flex-w size-302 m-t-73 p-tb-15">
			<span class="stext-107 cl6 p-lr-25">
				Try buying more products, then qualify for free delivery.
			</span>
		...
		$('.js-addcart-detail').each(function(){
			...
			$(this).on('click', function(){
               ...
               function addedToCart(){
                ...
                swal("<?php echo $product['productTitle']; ?>", "is added to cart !", "success");
               }
               <?php if(isset($added)===TRUE):?>
               addedToCart();
               <?php endif; ?>
